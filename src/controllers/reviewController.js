...
exports.createReview = async (req, res) => {
  try {
    ...
    const order = await Order.findOne({
        userId: new mongoose.Types.ObjectId(new mongoose.Types.ObjectId(req.user.id)),
        "orderItems.productId": new mongoose.Types.ObjectId(new mongoose.Types.ObjectId(productId)),
        paymentStatus: "Paid",
